...
public class BSMotionSensorsPlugin extends CordovaPlugin implements SensorEventListener {
    ...
    private Runnable mainRunnable =new Runnable() {
        public void run() {
            BSMotionSensorsPlugin.this.timeout();
        }
    };
    ...
    */
    private int start() {
        ...
        if ((list != null) && (list.size() > 0)) {
          ...
          if (this.sensorManager.registerListener(this, this.mSensor, SensorManager.SENSOR_DELAY_UI)) {
              ...
              this.fail(BSMotionSensorsPlugin.ERROR_FAILED_TO_START, "Device sensor returned an error.");
              return this.status;
          };

        } else {
          this.setStatus(BSMotionSensorsPlugin.ERROR_FAILED_TO_START);
          this.fail(BSMotionSensorsPlugin.ERROR_FAILED_TO_START, "No sensors found to register accelerometer listening to.");
          return this.status;
        }
    ...
    private void timeout() {
        if (this.status == BSMotionSensorsPlugin.STARTING) {
